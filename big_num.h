...
{
public:
    linkedList createfromstring(string str1);
    ...
    linkedList add_bigNum(linkedList& opr1, linkedList& opr2, linkedList& opr3);
    linkedList sub_bigNum(linkedList& opr1, linkedList& opr2);//减法
     linkedList sub_bigNum(linkedList& opr1, linkedList& opr2, linkedList& opr3);
    linkedList mul_bigNum(linkedList& opr1, linkedList& opr2);//乘法
    linkedList mul_bigNum(linkedList& opr1, linkedList& opr2, linkedList& opr3);
    ...
    linkedList ind_bigNum(linkedList opr1, linkedList opr2, linkedList& opr3);
    linkedList div_bigNum(linkedList& opr1, linkedList& opr2, linkedList& opr3);
    /*
